...
const source = fs.readFileSync('c:/Users/KMH/Desktop/Project/mytoken/contracts/MyToken.sol', 'utf8');
const compiledContract = solc.compile(source, 1);
const abi = compiledContract.contracts[':MyToken'].interface;
const bytecode = '0x' + compiledContract.contracts[':MyToken'].bytecode;
